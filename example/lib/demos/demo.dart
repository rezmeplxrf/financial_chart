...
abstract class DemoBasePageState extends State<DemoBasePage> with TickerProviderStateMixin {
  DemoBasePageState();
  ...
  void loadData() async {
    loadSampleData(simulateLatencyMillis: simulateDataLatencyMillis, simulateEmpty: simulateEmptyData).then((value) {
      setState(() {
