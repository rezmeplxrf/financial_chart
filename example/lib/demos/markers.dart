  ...
  GChart buildChart(GDataSource dataSource) {
    ...
    List<GPanel> panels = [
      GPanel(
        ...
        graphs: [
          ...
          GGraphLine(id: "line", valueViewPortId: "price", valueKey: keySMA, graphMarkers: [
            GCalloutMarker(
              id: "c1",
              text: "This pins to \nfixed position of \nthe view port",
            ...
            GRectMarker(
              ...
              theme: GGraphMarkerTheme(
                markerStyle: PaintStyle(fillColor: Colors.yellow.withAlpha(100), strokeColor: Colors.yellow),
              ),
            ),
            GArrowMarker(
            ...
            if (dataSource.length > 0)
              GLineMarker(
                coordinates: [
                  GCustomCoord(
                    x: 0,
                    y: dataSource.getSeriesValue(point: dataSource.lastPoint, key: keySMA)!,
                    coordinateConvertor: kCoordinateConvertorXPositionYValue,
                  ),
                  GViewPortCoord(
                    point: dataSource.lastPoint.toDouble(),
                    value: dataSource.getSeriesValue(point: dataSource.lastPoint, key: keySMA)!,
                  ),
                ],
                theme: GGraphMarkerTheme(
            ...
            GOvalMarker.anchorAndRadius(
              ...
              theme: GGraphMarkerTheme(
                markerStyle: PaintStyle(fillColor: Colors.red.withAlpha(100), strokeColor: Colors.red),
              ),
            ),
            ...
            GShapeMarker(
              anchorCoord: GViewPortCoord(
                ...
                value: dataSource.getSeriesValue(point: dataSource.lastPoint - 10, key: keySMA)!,
              ),
            ...
            GShapeMarker(
              anchorCoord: GViewPortCoord(
                ...
                value: dataSource.getSeriesValue(point: dataSource.lastPoint - 20, key: keySMA)!,
              ),
              radiusSize: GSize.viewSize(20),
            ...
            GShapeMarker(
              anchorCoord: GViewPortCoord(
                ...
                value: dataSource.getSeriesValue(point: dataSource.lastPoint - 30, key: keySMA)!,
              ),
              radiusSize: GSize.viewSize(20),
              pathGenerator: (radius) => GShapes.polygon(radius, vertexCount: 6),
            ),
            GShapeMarker(
              anchorCoord: GViewPortCoord(
                point: (dataSource.lastPoint - 40).toDouble(),
                value: dataSource.getSeriesValue(point: dataSource.lastPoint - 40, key: keySMA)!,
              ),
              radiusSize: GSize.viewSize(20),
            ...
            GAxisMarker(
              ...
              pointRanges: [GRange.range(dataSource.lastPoint - 60, dataSource.lastPoint - 50)],
              values: [dataSource.getSeriesValue(point: dataSource.lastPoint, key: keySMA)!],
            ),
          ]),
        ],
        tooltip: GTooltip(
    ...
    return GChart(
      ...
      pointViewPort: GPointViewPort(
        autoScaleStrategy: const GPointViewPortAutoScaleStrategyLatest(endSpacingPoints: 20),
      ),
      panels: panels,
      theme: chartTheme,
    );
      ...
      children: [
        ...
        AppLabelWidget(
          ...
          child: AppPopupMenu<Alignment>(
            ...
            onSelected: (Alignment selected) {
              (chart!.panels[0].findGraphById("line")!.findGraphMarker("c1") as GCalloutMarker).alignment =
                  Alignment(-selected.x, -selected.y);
              (chart!.panels[0].findGraphById("line")!.findGraphMarker("c1") as GCalloutMarker).keyCoordinates
                ..clear()
                ..add(
                  GPositionCoord.rational(x: selected.x * 0.5 + 0.5, y: selected.y * 0.5 + 0.5),
                );
              repaintChart();
            },
            selected: Alignment(
              -(chart!.panels[0].findGraphById("line")!.findGraphMarker("c1") as GCalloutMarker).alignment.x,
              -(chart!.panels[0].findGraphById("line")!.findGraphMarker("c1") as GCalloutMarker).alignment.y,
            ),
          ),
        ),
        AppLabelWidget(
        ...
        AppLabelWidget(
          ...
          child: AppPopupMenu<bool>(
            items: const [true, false],
            onSelected: (bool selected) {
              for (var marker in chart!.panels[0].findGraphById("line")!.graphMarkers) {
                marker.visible = selected;
              }
              for (var marker in chart!.panels[0].findGraphById("line")!.axisMarkers) {
                marker.visible = selected;
              }
              repaintChart();
            },
            selected: chart!.panels[0].findGraphById("line")!.graphMarkers[0].visible,
          ),
        ),
      ],
    );
