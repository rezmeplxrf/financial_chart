...
abstract class GRender<C extends GComponent, T extends GComponentTheme> {
  ...
  void renderClipped({
    ...
    GRenderUtil.renderClipped(canvas: canvas, clipRect: clipRect, render: render);
  }
  ...
  Rect drawValueAxisLabel({
    ...
    return GRenderUtil.drawValueAxisLabel(
        canvas: canvas, text: text, axis: axis, position: position, axisArea: axisArea, labelTheme: labelTheme);
  }
  ...
  Path addRectPath({
    ...
    double cornerRadius = 0,
      ...
      GRenderUtil.addRectPath(toPath: toPath, rect: rect, cornerRadius: cornerRadius);
  ...
  Path addOvalPath({
    ...
    double cornerRadius = 0,
      ...
      GRenderUtil.addOvalPath(toPath: toPath, rect: rect, cornerRadius: cornerRadius);
  ...
  Path addPolygonPath({
    ...
    double cornerRadius = 0,
      ...
      GRenderUtil.addPolygonPath(toPath: toPath, points: points, close: close, cornerRadius: cornerRadius);
  ...
  Offset valueAxisLabelAnchor({
    ...
    required GAxisLabelTheme labelTheme,
      ...
      GRenderUtil.valueAxisLabelAnchor(axis: axis, position: position, axisArea: axisArea, labelTheme: labelTheme);

  Alignment valueAxisLabelAlignment({required GValueAxis axis}) => GRenderUtil.valueAxisLabelAlignment(axis: axis);
  ...
  Offset pointAxisLabelAnchor({
    ...
    required GAxisLabelTheme labelTheme,
      ...
      GRenderUtil.pointAxisLabelAnchor(axis: axis, position: position, axisArea: axisArea, labelTheme: labelTheme);

  Alignment pointAxisLabelAlignment({required GPointAxis axis}) => GRenderUtil.pointAxisLabelAlignment(axis: axis);
