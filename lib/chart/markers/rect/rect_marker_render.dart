...
class GRectMarkerRender extends GGraphMarkerRender<GRectMarker, GGraphMarkerTheme> {
  ...
  void doRenderMarker({
    ...
    if(marker.keyCoordinates.length == 2) {
      ...
      final cornerRadius = marker.cornerRadiusSize?.toViewSize(area: area, pointViewPort: pointViewPort, valueViewPort: valueViewPort) ?? 0;
      Path path = addRectPath(rect: Rect.fromPoints(start, end), cornerRadius: cornerRadius);
